 ...
 * 
 */
@WebServiceClient(name = "AuctionServiceService", targetNamespace = "http://it/eng/projectwork/wsdl/auction_01", wsdlLocation = "file:/C:/deveng/progetti/book/projectwork/projectwork-ws/src/main/webapp/WEB-INF/wsdl/auction_services_01.01.wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUCTIONSERVICESERVICE_QNAME = new QName("http://it/eng/projectwork/wsdl/auction_01", "AuctionServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/deveng/progetti/book/projectwork/projectwork-ws/src/main/webapp/WEB-INF/wsdl/auction_services_01.01.wsdl");
